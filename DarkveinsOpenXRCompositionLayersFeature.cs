...
namespace Darkveins.Utilities
{
    ...
    [OpenXRFeature(UiName = FeatureName,
        ...
        Company = "Niftysoft",
        OpenxrExtensionStrings = "XR_DV_composition_layer_cylinder XR_DV_composition_layer_equirect XR_DV_composition_layer_equirect2 XR_DV_composition_layer_cube XR_DV_composition_layer_color_scale_bias XR_DV_android_surface_swapchain",
        Version = "1.0.0",
...
#endif
    public class DarkveinsOpenXRCompositionLayersFeature : OpenXRFeature
    {
        public const string FeatureId = "com.niftysoft.openxr.feature.darkveinscompositionlayers";
        internal const string FeatureName = "Darkveins: Passthrough Patch for OpenXR Meta";
